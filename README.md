...
'globe` prints an ASCII rendering of the sunlit side of the Earth at the current moment.  
This version was originally distributed through Homebrew as `globe 0.0.20140814`  
but has since been **disabled and removed** (Dec 6, 2024).

This repository preserves:
- The working executable binary (`globe`)
- The original 1994 README (`README.txt`)
